 ...
 * Map<String, String> of columnName -> cellValue. An index column can be included 
 * explicitly or generated automatically.
 *
 * This class is Iterable and indexable:
 *   - for-each loop usage via the iterator()
 *   - get(i) to retrieve the i-th row
 */
public class Dataframe implements Iterable<Map<String, String>> {

    /**
     * Internally holds one Map per row:
     *    rowData = { "index": "0", "Column A": "some value", ... }
     */
